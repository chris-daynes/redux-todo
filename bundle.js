...
var mainTemplate = require('./views/mainTemplate');
...
var upDateView = function upDateView() {
  var state = getState();
  var newView = mainTemplate(state, dispatch);
  morph(initView, newView);
};

// dispatch(state, {type: 'INIT'})

},{"./reducer":38,"./views/mainTemplate":39,"morphdom":23,"redux":31,"yo-yo":36}],2:[function(require,module,exports){
'use strict'
...
function reducer(state, action) {
  ...
  var newState = clone(state); // ensures that the reducer does not alter the state
